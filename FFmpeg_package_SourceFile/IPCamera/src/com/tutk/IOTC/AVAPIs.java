...
public class AVAPIs {
	...
	* after a specified timeout expires. */
	...
	/**开启音频*/
	public static final int IOTYPE_USER_IPCAM_AUDIOSTART            = 0x300;
	/**关闭音频*/
	...
	public native static int  avInitialize(int nMaxNumAllowed);//初始化AV模块并设置最多通道数 
	...
	{
	    byte[] bPwd = viewPwd.getBytes();//密码
	    byte[] bAcc = viewAcc.getBytes();//账号

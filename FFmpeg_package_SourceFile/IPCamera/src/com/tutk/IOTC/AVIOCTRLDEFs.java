...
//	//灯的开关控制值
//	public static final int IOTYPE_USER_IPCAM_LED1ON = 0x0801;
//	public static final int IOTYPE_USER_IPCAM_LED1OFF = 0x0802;
//	public static final int IOTYPE_USER_IPCAM_LED2ON = 0x0803;
//	public static final int IOTYPE_USER_IPCAM_LED2OFF = 0x0803;
	//设置接收音频数据类型
	public static final int IOTYPE_USER_IPCAM_SETAUDIOFORMAT_REQ = 0x0805;
	public static final int IOTYPE_USER_IPCAM_SETAUDIOFORMAT_RESP = 0x0806;
	
	//设备录像控制
	public static final int IOTYPE_USER_IPCAM_RECORDRSTART = 0x0803;
	public static final int IOTYPE_USER_IPCAM_RECORDSTOP = 0x0804;
	//灯的开关type
	public static final int IOTYPE_USER_IPCAM_LEDON = 0x0801;
	public static final int IOTYPE_USER_IPCAM_LEDOFF = 0x0802;
	//报警开关控制type
	public static final int IOTYPE_USER_IPCAM_ALARMON = 0x0901;
	public static final int IOTYPE_USER_IPCAM_ALAROFF = 0x0902;
	...
	public static final int IOTYPE_USER_IPCAM_SETSTREAMCTRL_REQ = 0x0320;//设置视频质量等级
	public static final int IOTYPE_USER_IPCAM_SETSTREAMCTRL_RESP = 0x0321;
	public static final int IOTYPE_USER_IPCAM_GETSTREAMCTRL_REQ = 0x0322;//获取视频质量等级
	...
	public static final int IOTYPE_USER_IPCAM_PTZ_COMMAND = 0x1001;//云台控制type
   ...
   //云台控制
	...
	//音频格式设置(自己添加的)
	public static class SMsgAVIoctrlSetAudioFormatReq{
		int channel;
		byte format;//AVFrame类中的Codec ID
		byte[] reserved = new byte[3];
		public static byte[] parseContent(int channel, byte format) {

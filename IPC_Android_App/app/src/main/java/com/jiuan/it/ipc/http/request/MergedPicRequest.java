...
public class MergedPicRequest extends BaseRequest {

    public static final String PATH = BaseRequest.PATH + "camera/MergedPic";
    ...
    private class TypeCodeDetailRequestBody extends BaseRequestBody {
        ...
        private TypeCodeDetailRequestBody() {
            setSv(BaseRequestConfig.SV_MERGED_PIC);
        }

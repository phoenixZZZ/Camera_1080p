...
public class BindWBoxUserRequest extends BaseRequest {

    public static final String PATH = BaseRequest.PATH + "api/Bind_WBoxUser";
    ...
    private class BindWBoxUserRequestBody extends BaseRequestBody {
        ...
        private BindWBoxUserRequestBody() {
            setSv(BaseRequestConfig.SV_BIND_WBOXUSER);
        }

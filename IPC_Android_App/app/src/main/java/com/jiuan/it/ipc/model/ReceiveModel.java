...
public class ReceiveModel implements Parcelable {
    ...
    @SerializedName("GetStreamCtrlType")
    private int streamCtrlType;
    ...
    @SerializedName("PictureDirName")
    private String pictureDirName;

    @SerializedName("IsRecodering")
    private int isRecodering;
    ...
    @SerializedName("PTZResp")
    private int resp;

    @SerializedName("PTZAngleCurrent")
    private int angleCurrent;

    public static final Creator<ReceiveModel> CREATOR = new Creator<ReceiveModel>() {
        @Override
        public ReceiveModel createFromParcel(Parcel in) {
            ...
            model.streamCtrlType = in.readInt();
            model.version = in.readString();
            model.isControl = in.readInt();
            model.pictureDirName = in.readString();
            model.isRecodering = in.readInt();
            model.isRecording = in.readInt();
            model.isMax = in.readInt();
            model.resp = in.readInt();
            model.angleCurrent = in.readInt();

            return model;
        }

        @Override
        public ReceiveModel[] newArray(int size) {
            return new ReceiveModel[size];
        }
    };
    ...
    public int getStreamCtrlType() {
        return streamCtrlType;
    }

    public void setStreamCtrlType(int streamCtrlType) {
        this.streamCtrlType = streamCtrlType;
    }
    ...
    public void setPictureDirName(String pictureDirName) {
        this.pictureDirName = pictureDirName;
    }

    public int getIsRecodering() {
        return isRecodering;
    }

    public void setIsRecodering(int isRecodering) {
        this.isRecodering = isRecodering;
    }
    ...
    public void writeToParcel(Parcel parcel, int flags) {
        ...
        parcel.writeInt(streamCtrlType);
        parcel.writeString(version);
        parcel.writeInt(isControl);
        parcel.writeString(pictureDirName);
        parcel.writeInt(isRecodering);
        parcel.writeInt(isRecording);
        parcel.writeInt(isMax);
        parcel.writeInt(resp);
        parcel.writeInt(angleCurrent);
    }
}
